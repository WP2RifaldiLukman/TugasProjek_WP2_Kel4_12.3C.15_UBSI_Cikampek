					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<div class="box-header with-border">
								...
								<h3 class="box-title">Update Data Rute Kereta</h3>
							</div>
							<!-- /.box-header -->
							<!-- form start -->
							<form role="form" method="POST" action="<?=base_url();?>master_data/update_rute_kereta"
								...
								<div class="box-body">
                                    ...
                                    <input type="hidden" value="<?= $rute_kereta->id_rute; ?>" name="id" >                
										...
										<div class="col-12">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="rute_asal" value="<?= $rute_kereta->rute_asal; ?>"
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="kode_asal" value="<?= $rute_kereta->kode_asal; ?>"
										...
										<div class="col-12">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="rute_tujuan" value="<?= $rute_kereta->rute_tujuan; ?>"
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="kode_tujuan" value="<?= $rute_kereta->kode_tujuan; ?>"
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select name="kelas_kereta" id="kelas-kereta" class="form-control"> 
                                                        ...
                                                        <option
                                                                value="<?= $data_kelas_kereta->id_kelas; ?>"> <?=$data_kelas_kereta->kls_kereta; ?>
                                                        </option>
														<?php endforeach; ?>
													</select>
												</div>
										...
										<div class="col-12">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" class="form-control" name="tarif" value="<?= $rute_kereta->tarif_rute; ?>"
